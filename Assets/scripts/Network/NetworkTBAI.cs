...
public class NetworkTBAI : NetworkBehaviour, IBoss
{
    ...
    public override void OnNetworkDespawn()
    {
        ...
        isAttacking = false;
        targetCell = null;
        // Reward Immune team for killing the TB
        NetworkRewardSystem.Instance.RegisterEnemyKillServerRpc("Tuberculosis"); // Register the kill for reward purposes
    }
